    ...
    <div className="mx-5 md:w-1/2 lg:w-2/5">
      ...
      <div className="mb-5">
        ...
        <div className="mb-5">
          ...
          <input id="email" className="border-2 w-full p-2 mt-2 placeholderbg-gray-400 rounded-md" type="date"
            value={fecha}
        ...
        <div className="mb-5">
          ...
          <textarea id="sintomas" className="border-2 w-full p-2 mt-2 placeholderbg-gray-400 rounded-md" type="text" placeholder="Escribe los sintomas..."
            value={sintomas}
